...
public class Menu {
    public void exibir() {
        ...
        do {
            ...
            switch (escolha) {
                case 1:
                    Conversor.converteCoin("USD", "BRL", scanner);
                    break;
                case 2:
                    Conversor.converteCoin("BRL", "USD", scanner);
                    break;
                case 3:
                    Conversor.converteCoin("USD", "ARS", scanner);
                    break;
                case 4:
                    Conversor.converteCoin("ARS", "USD", scanner);
                    break;
                case 5:
                    Conversor.converteCoin("USD", "COP", scanner);
                    break;
                case 6:
                    Conversor.converteCoin("COP", "USD", scanner);
                    break;
                case 7:
                    EscolheMoeda.enterValue(scanner);
                    break;
                case 8:
